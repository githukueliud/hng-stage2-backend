...
public class RegistrationTests {
    ...
    void testLoginUserSuccessfully() throws Exception {
        ...
        mockMvc.perform(post("/auth/login")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"email\":\"my@example.com\",\"password\":\"password\"}"))
    ...
    void testRegisterUserFailsIfDuplicateEmail() throws Exception {
        ...
        existingUser.setEmail("jim@example.com");
        Mockito.when(userRepository.findUserByEmail("jim@example.com")).thenReturn(java.util.Optional.of(existingUser));

        // Act & Assert
        mockMvc.perform(post("/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\":\"John\",\"lastName\":\"Doe\",\"email\":\"jim@example.com\",\"password\":\"password\",\"phone\":\"1234567890\"}"))
